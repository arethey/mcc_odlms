...
<?php
$sched_query = $conn->query("SELECT a.*,p.firstname,p.lastname FROM `appointment_list` a inner join `client_list` p on a.client_id = p.id");
        ...
        var calendar = new Calendar(calendarEl, {
                        ...
                        events:function(event,successCallback){
                            ...
                            Object.keys(scheds).map(k=>{
                                ...
                                events.push({
                                    id          : scheds[k].id,
                                    title          : scheds[k].lastname,
                                    start          : moment(scheds[k].schedule).format('YYYY-MM-DD[T]HH:mm'),
                                    backgroundColor: bg, 
                                    borderColor: bg, 
                                    });
                            })
                        ...
                        eventClick:(info)=>{
                            console.log(info);
                            uni_modal("Appointment Details","appointments/view_appointment.php?id="+info.event.id,'mid-large')
                        },
                        editable  : false,
                        selectable: true,
