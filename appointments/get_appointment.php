...
<div class="content py-5">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h4 class="card-title hidden-print"><b>Booked Appointment Details</b></h4>
            <div class="card-tools">
                <?php if(isset($status) && $status == 0): ?>
                <button class="btn btn-danger bg-gradient-maroon btn-flat btn-sm hidden-print" type="button" id="cancel_data"> Cancel Appointment</button>
                <?php endif; ?>
                <?php if(isset($status) && $status <= 1): ?>
                <button class="btn btn-primary btn-flat btn-sm" type="button" id="edit_data"><i class="fa fa-edit"></i> Edit</button>
                <button onclick="window.print()"class="btn btn-success btn-flat btn-sm" type="button" id="print_data"><i class="fa fa-print"></i>Print</button>
