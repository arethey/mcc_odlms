...
Class Master extends DBConnection {
	...
	function save_appointment(){
		...
		$newtimestamp = date('Y-m-d H:i:s', strtotime('+20 minutes', strtotime($date_sched)));
		$check = $this->conn->query("SELECT * FROM `appointment_list` where schedule > '$date_sched' and schedule < DATE_ADD('$date_sched', INTERVAL 20 MINUTE );");
		//var_dump("SELECT * FROM appointment_list where schedule > '$date_sched' and  schedule  < DATE_ADD('$date_sched', interval 20 MINUTE)");
