          ...
          <div class="card-body rounded-0 text-dark">
            <form id="registration-frm" action="" method="post">
              ...
              <div class="row">
                  ...
                  <div class="form-group col-md-4">
                      <input type="date" name="dob" id="dob" max="<?php echo date('Y-m-d') ?>" placeholder="(optional)" required class="form-control form-control-sm form-control-border">
                      <small class="mx-2">Birthday</small>
                  </div>
                  <div class="form-group col-md-4">
                      <input type="tel" name="contact" id="contact" placeholder="0943-123-1234" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" required class="form-control form-control-sm form-control-border">
              ...
              <div class="row">
                    <div class="form-group col-md-10">
                      <input type="email" name="email" id="email" placeholder="sample@sample.com" required class="form-control form-control-sm form-control-border">
                      <small class="mx-2">Email</small>
                  </div>
              </div>
              <div class="row">
                    <div class="form-group col-md-10">
                      <input type="password" name="password" id="password" required class="form-control form-control-sm form-control-border" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
